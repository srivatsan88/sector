...
**Sector** is a Python library developed for advanced text extraction, comparison, and intelligent matching. It enables users to identify the most relevant sentences between an input sentence and a reference document, utilizing techniques such as semantic alignment and customizable probabilistic matching to deliver precise and context-aware comparisons.
