import json
from comparator import compare_sentences_flexible, geometric_mean_top_n
import math
...
def run_sector (input_text, reference_document,  max_window_size=2,  use_semantic=True, combine_threshold=0.85, top_n_individual=2, top_n_aggregated=2):
